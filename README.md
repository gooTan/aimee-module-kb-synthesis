# Aimee module: kb-synthesis

This is the independent `kb-synthesis` source-ownership repository.

It builds `aimee-module-kb-synthesis` as a separate Go process for the
